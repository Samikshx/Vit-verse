...
const checkIfWalletConnected = async () => {
    ...
    //   setOpenError(true);
    console.log("Something wrong while connecting wallets");
    }
  };
...
return(
    <NFTMarketplaceContext.Provider value={{uploadToIPFS,connectWallet,titleData,createNFT,createSale,fetchNFTs,fetchMyNFTsOrListedNFTs,buyNFT,currentAccount,checkIfWalletConnected}}>
    {children}
